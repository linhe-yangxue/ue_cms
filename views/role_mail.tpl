  ...
  <div class="panel-body">
    <form class="form-horizontal" id="add_mail">
      ...
      <div class="form-group">
        ...
        <!-- <label for="is_bind" class="col-sm-1 control-label">XX{{i}}:</label>
        <div class="col-sm-2">
          <select class="form-control required" id="bind">
            <option bind="True">是</option>
            <option bind="False">否</option>
          </select>
        </div> -->
        % end
      </div>
